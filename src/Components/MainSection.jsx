...
export const MainSection = () => {
  ...
  const products = [
    { name: 'Washing Machine', price: '$99.99', originalPrice: '$299.99', image: fridge },
    { name: 'Refrigerator', price: '$99.99', originalPrice: '$299.99', image: washingMachine },
    { name: 'Television', price: '$99.99', originalPrice: '$299.99', image: television },
  ...
  return (
    <div className='main'>
        <div className='left'>
        <div className='hot-deals-container' style={{ display: 'flex', gap: '20px', marginBottom: '30px', borderRadius: '15px', overflow: 'hidden' }}>
          ...
          <div style={{ 
            ...
            <div>
              <h2 style={{ fontSize: '28px', fontWeight: 'bold', marginBottom: '10px' }}>
                Hot Deals <span style={{ display: 'inline-block', width: '40px', height: '3px', backgroundColor: '#e84c7d', marginLeft: '10px' }}></span>
              </h2>
              <p style={{ fontSize: '14px', color: '#999', marginBottom: '20px' }}>Our lowest prices EVER!</p>
              <p style={{ fontSize: '13px', lineHeight: '1.6', color: '#ccc', marginBottom: '20px' }}>
                Get premium washing machine repair services at unbeatable prices. Professional technicians, 30-day warranty, and quick response times!
              </p>
            </div>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button onClick={() => setCurrentSlide(prev => (prev - 1 + products.length) % products.length)} style={{
                width: '40px', height: '40px', borderRadius: '50%', border: 'none',
                backgroundColor: '#555', color: 'white', cursor: 'pointer', fontSize: '16px'
              }}>
                ‹
              </button>
              <button onClick={() => setCurrentSlide(prev => (prev + 1) % products.length)} style={{
                width: '40px', height: '40px', borderRadius: '50%', border: 'none',
                backgroundColor: '#e84c7d', color: 'white', cursor: 'pointer', fontSize: '16px'
              }}>
                ›
              </button>
            </div>
            ...
            <div style={{
              ...
              {products.map((product, index) => (
                <div key={index} style={{
                  ...
                  <h4 style={{ fontSize: '14px', fontWeight: 'bold', marginBottom: '8px', color: '#333' }}>{product.name}</h4>
               
                  <div style={{ marginBottom: '12px', fontSize: '12px', color: '#ffc107' }}>★★★★★</div>
